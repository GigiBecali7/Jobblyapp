...
const USP_ITEMS = [
  ...
  { icon: '🔔', title: 'Instant job alerts', desc: 'Get notified the moment your dream job is posted on StepStone, LinkedIn, Indeed, Willhaben and 5 more platforms.' },
...
const HOW_STEPS = [
  ...
  { n: '03', icon: '🔔', label: 'Get instant job alerts', desc: 'We monitor 8+ European platforms and notify you the moment a match appears.' },
...
const PRO_FEATURES = [
  ...
  'Instant job alerts from 8+ European platforms',
  'AI auto-adapts cover letter to each job posting',
  'Edit all CV and cover letter fields before export',
  'PDF and Word (.docx) export',
  '3 premium CV designs with photo support (Nordic Minimal, Mono Elegant, Split Premium)',
  'Priority support',
]
...
const COMPARISON = [
  ...
  { feature: 'Job alerts (8+ platforms)', jobbly: true,  makemycv: false, zety: false, resume: false },
